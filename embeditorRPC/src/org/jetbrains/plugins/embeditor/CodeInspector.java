...
public class CodeInspector {
    public static List<Problem> inspect(PsiFile file) {
        ...
        LocalInspectionsPass pass = new LocalInspectionsPass(file, document, 0, file.getTextLength(), LocalInspectionsPass.EMPTY_PRIORITY_RANGE, true, new DefaultHighlightInfoProcessor());
